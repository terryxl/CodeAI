...
export const DOTCOM_URL = new URL((typeof process === 'undefined' ? null : process.env.TESTING_DOTCOM_URL) ?? 'https://sourcegraph.com');
export const DOTCOM_AZURE_URL = new URL((typeof process === 'undefined' ? null : process.env.TESTING_DOTCOM_URL) ?? 'https://homegpt-plus.openai.azure.com'
