...
const hallucinate = 'If context is available: never make any assumptions nor provide any misleading or hypothetical examples.';
...
export class PromptMixin {
    ...
    static defaultMixin = new PromptMixin(CODY_INTRO_PROMPT);
    /**
...
export function newPromptMixin(text) {
    return new PromptMixin(text);
}
//# sourceMappingURL=prompt-mixin.js.map