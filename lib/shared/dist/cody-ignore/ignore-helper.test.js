...
describe('IgnoreHelper', () => {
    ...
    function setIgnores(workspaceRoot, ignoreFolder, rules) {
    ...
    function setWorkspace1Ignores(rules) {
        setIgnores(workspace1Root, '.', rules);
    }
    function setWorkspace2Ignores(rules) {
        setIgnores(workspace2Root, '.', rules);
    }
    function setWorkspace1NestedIgnores(folder, rules) {
    ...
    describe('returns the correct value for a sample of rules', () => {
        ...
        it.each([
            ...
            'one/a/two',
            'one/a/two/three',
        ])('returns true for file in ignore list %s', (filePath) => {
        ...
        it.each([
            ...
            'one/three',
            'two/one',
        ])('returns false for file not in ignore list %s', (filePath) => {
...
//# sourceMappingURL=ignore-helper.test.js.map