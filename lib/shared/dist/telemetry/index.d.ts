...
export interface TelemetryService {
     ...
     */
    log(eventName: string, properties?: TelemetryEventProperties, opts?: {
        /**
...
export interface TelemetryEventProperties {
    [key: string]: string | number | boolean | null | undefined | string[] | TelemetryEventProperties[] | TelemetryEventProperties;
}
/** For testing. */
export declare const NOOP_TELEMETRY_SERVICE: TelemetryService;
