...
export class EventLogger {
    ...
    client;
    siteIdentification;
    constructor(serverEndpoint, extensionDetails, config) {
    ...
    onConfigurationChange(newServerEndpoint, newExtensionDetails, newConfig) {
        ...
        this.setSiteIdentification().catch(error => logError('EventLogger', 'onConfigurationChange.setSiteIdentification', error));
    }
    async setSiteIdentification() {
     ...
     */
    log(eventName, anonymousUserID, properties, opts = { hasV2Event: false }) {
        /**
