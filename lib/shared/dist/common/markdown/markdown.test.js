...
describe('renderMarkdown', () => {
    ...
    it('forbids <svg> tags', () => {
        const input = '<svg viewbox="10 10 10 10" width="100"><rect x="37.5" y="7.5" width="675.0" height="16.875" fill="#e05d44" stroke="white" stroke-width="1"><title>/</title></rect></svg>';
    ...
    it('adds target="_blank" attribute on links with addTargetBlankToAllLinks: true', () => {
        ...
        expect(renderMarkdown(input, { addTargetBlankToAllLinks: true })).toBe('<p><a href="/" target="_blank" rel="noopener">Link</a></p>');
    });
