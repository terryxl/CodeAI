...
export function contextMessageToContextItem(
...
export function contextItemsToContextFiles(
    items: ContextItem[]
): ContextFile[] {
...
export function getChatPanelTitle(
...
export function viewRangeToRange(
    range?: ActiveTextEditorSelectionRange
