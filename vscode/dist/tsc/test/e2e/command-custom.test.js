...
test.extend({
    ...
    await page
        ...
        .click();
    // Enter command name
    await (0, test_1.expect)(page.getByText('New Custom Cody Command: Command Name')).toBeVisible();
    await page.keyboard.type(commandName);
    await page.keyboard.press('Enter');
    // Enter prompt
    await (0, test_1.expect)(page.getByText('New Custom Cody Command: Prompt')).toBeVisible();
    await page.keyboard.type(prompt);
    await page.keyboard.press('Enter');
    // Use default context
    await (0, test_1.expect)(page.getByText('New Custom Cody Command: Context Options')).toBeVisible();
    await page.keyboard.press('Enter');
    // Save it to workspace settings
    await (0, test_1.expect)(page.getByText('New Custom Cody Command: Save To…')).toBeVisible();
    await (0, test_1.expect)(page.getByText('Workspace Settings.vscode/cody.json')).toBeVisible();
    ...
    await (0, test_1.expect)(page.getByText(commandName)).toBeVisible();
    ...
    await (0, test_1.expect)(page.getByText('Cody: Custom Commands (Beta)')).toBeVisible();
    await (0, test_1.expect)(page.getByText(commandName)).toBeVisible();
    ...
    await (0, test_1.expect)(chatPanel.getByText(prompt)).toBeVisible();
});
...
test.extend({
    ...
    await (0, test_1.expect)(page.getByPlaceholder('Search command to run...')).toBeVisible();
    await page.getByPlaceholder('Search command to run...').fill('currentDir');
    await page.keyboard.press('Enter');
    const chatPanel = page.frameLocator('iframe.webview').last().frameLocator('iframe');
    await (0, test_1.expect)(chatPanel.getByText('Add four context files from the current directory.')).toBeVisible();
    // Show the current file numbers used as context
    await (0, test_1.expect)(chatPanel.getByText('✨ Context: 61 lines from 5 files')).toBeVisible();
    ...
    await (0, test_1.expect)(chatPanel.locator('span').filter({ hasText: '@.mydotfile:1-2' })).not.toBeVisible();
    await (0, test_1.expect)(chatPanel.locator('span').filter({ hasText: '@error.ts:1-10' })).toBeVisible();
    await (0, test_1.expect)(chatPanel.locator('span').filter({ hasText: '@Main.java:1-10' })).toBeVisible();
    await (0, test_1.expect)(chatPanel.locator('span').filter({ hasText: '@buzz.test.ts:1-13' })).toBeVisible();
    await (0, test_1.expect)(chatPanel.locator('span').filter({ hasText: '@buzz.ts:1-16' })).toBeVisible();
    await (0, test_1.expect)(chatPanel.locator('span').filter({ hasText: '@index.html:1-12' })).toBeVisible();
    ...
    await page.keyboard.press('Enter');
    await (0, test_1.expect)(chatPanel.getByText('Add lib/batches/env/var.go as context.')).toBeVisible();
    // Should show 2 files with current file added as context
    await (0, test_1.expect)(chatPanel.getByText('✨ Context: 14 lines from 2 files')).toBeVisible();
    ...
    await page.keyboard.press('Enter');
    await (0, test_1.expect)(chatPanel.getByText('Directory has one context file.')).toBeVisible();
    await (0, test_1.expect)(chatPanel.getByText('✨ Context: 14 lines from 2 file')).toBeVisible();
    await chatPanel.getByText('✨ Context: 14 lines from 2 file').click();
    await (0, test_1.expect)(chatPanel.locator('span').filter({ hasText: (0, helpers_1.withPlatformSlashes)('@lib/batches/env/var.go:1-2') })).toBeVisible();
    // Click on the file link should open the 'var.go file in the editor
    await chatPanel
        .getByRole('button', { name: (0, helpers_1.withPlatformSlashes)('@lib/batches/env/var.go:1-2') })
        .click();
    await (0, test_1.expect)(page.getByRole('tab', { name: 'var.go' })).toBeVisible();
    ...
    await page.keyboard.press('Enter');
    await (0, test_1.expect)(chatPanel.getByText('Open tabs as context.')).toBeVisible();
    // The files from the open tabs should be added as context
    await (0, test_1.expect)(chatPanel.getByText('✨ Context: 14 lines from 2 files')).toBeVisible();
    await chatPanel.getByText('✨ Context: 14 lines from 2 files').click();
    await (0, test_1.expect)(chatPanel.getByRole('button', { name: '@index.html:1-12' })).toBeVisible();
    await (0, test_1.expect)(chatPanel.getByRole('button', { name: (0, helpers_1.withPlatformSlashes)('@lib/batches/env/var.go:1-2') })).toBeVisible();
});
test.extend({
    // list of events we expect this test to log, add to this list as needed
    expectedEvents: [
    ...
    await (0, test_1.expect)(page.getByRole('button', { name: 'Open or Create Settings File' })).toBeVisible();
    await page.getByRole('button', { name: 'Open or Create Settings File' }).click();
    await page.getByRole('tab', { name: 'cody.json' }).hover();
    await (0, test_1.expect)(page.getByRole('tab', { name: 'cody.json' })).toBeVisible();
    ...
    await (0, test_1.expect)(page.getByRole('list').getByLabel(/cody.json(.*)Deleted$/)).toBeVisible();
    ...
    await page.getByRole('button', { name: 'Open or Create Settings File' }).click();
    await (0, test_1.expect)(page.getByRole('tab', { name: 'cody.json, preview' })).toHaveCount(1);
});
