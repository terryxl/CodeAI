...
helpers_1.test.skip('decorations from un-applied Cody changes appear', async ({ page, sidebar }) => {
    // Sign into Cody
    ...
    (0, test_1.expect)(await decorations.count()).toBe(0);
    ...
    (0, test_1.expect)(decorationClassName).toBeDefined();
