...
exports.getDocumentInputItems = exports.getDefaultDocumentItems = void 0;
const vscode = __importStar(require("vscode"));
const utils_1 = require("./utils");
const edit_selection_1 = require("../../utils/edit-selection");
const constants_1 = require("./constants");
const getDefaultDocumentItems = (document, initialValues) => {
...
exports.getDefaultDocumentItems = getDefaultDocumentItems;
const getDocumentInputItems = async (document, initialValues, activeRange, symbolsPromise) => {
    const defaultItems = (0, exports.getDefaultDocumentItems)(document, initialValues);
    const symbols = await symbolsPromise;
    const symbolItems = symbols
        .filter(sym => (0, utils_1.symbolIsFunctionLike)(sym) || (0, utils_1.symbolIsVariableLike)(sym))
        .map(symbol => {
        const icon = (0, utils_1.symbolIsFunctionLike)(symbol) ? '$(symbol-method)' : '$(symbol-variable)';
        return {
...
exports.getDocumentInputItems = getDocumentInputItems;
