...
exports.getModelHelpers = void 0;
const EOT_TOKEN = '<EOT>';
...
const MULTI_LINE_STOP_SEQUENCES = ['\n\n', EOT_TOKEN /* ...SHARED_STOP_SEQUENCES */];
class DefaultOllamaModel {
    ...
    getRequestOptions(isMultiline, isDynamicMultiline) {
        const params = {
...
function getModelHelpers(model) {
...
exports.getModelHelpers = getModelHelpers;
