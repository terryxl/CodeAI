...
exports.javascriptQueries = void 0;
 ...
 */
const JS_INTENTS_QUERY = (0, dedent_1.default) `
...
`;
const JSX_INTENTS_QUERY = (0, dedent_1.default) `
    ${JS_INTENTS_QUERY}

    (jsx_attribute (_) @jsx_attribute.value!)
`;
const TS_INTENTS_QUERY = (0, dedent_1.default) `
    ${JS_INTENTS_QUERY}
...
`;
const TSX_INTENTS_QUERY = (0, dedent_1.default) `
    ${TS_INTENTS_QUERY}

    (jsx_attribute (_) @jsx_attribute.value!)
`;
const TS_SINGLELINE_TRIGGERS_QUERY = (0, dedent_1.default) `
    (interface_declaration (object_type ("{") @block_start)) @trigger
    (type_alias_declaration (object_type ("{") @block_start)) @trigger
`;
const JS_DOCUMENTABLE_NODES_QUERY = (0, dedent_1.default) `
    ; Identifiers
    ;--------------------------------
    (_
...
`;
const TS_DOCUMENTABLE_NODES_QUERY = (0, dedent_1.default) `
