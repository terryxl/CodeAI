...
exports.computeDiff = exports.longestCommonSubsequence = exports.dumpUse = void 0;
function render(ch) {
    return ch === '\n' ? '@' : ch;
}
...
// of the text.
function updatedPosition(position, text) {
...
// treated as known.
function computeDiff(original, a, b, bStart) {
